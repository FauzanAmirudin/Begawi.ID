    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section class="mb-16">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-3xl font-medium text-charcoal-grey flex items-center gap-3">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-8">
                ...
                <div class="bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden border-2 border-gray-100 relative
                    ...
                    @if($produk['diskon'])
                    <span class="absolute top-4 left-4 px-3 py-1 rounded-full text-sm font-medium bg-red-500 text-white z-10">
                        Diskon {{ $produk['diskon'] }}%
                    </span>
                    @elseif($produk['unggulan'])
                    <span class="absolute top-4 left-4 px-3 py-1 rounded-full text-sm font-medium bg-primary-dark text-white z-10">
                        Best Seller
                    </span>
                    @endif
                    ...
                    <div class="p-3 md:p-5">
                        <h3 class="text-md md:text-lg font-medium text-[var(--color-navy)] truncate">
                            {{ $produk['nama'] }}
                        </h3>
                        <p class="text-[var(--color-navy)] font-medium mt-2 text-md md:text-lg">
