    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12" 
            ...
            <div class="w-full">
                ...
                <p class="text-3xl font-bold text-primary-dark mb-6">
                ...
                <div class="flex flex-col md:flex-row gap-4 mb-8">
                    ...
                    <a href="#" x-ref="whatsappLink" target="_blank" rel="noopener noreferrer"
                        class="flex-1 inline-flex items-center justify-center px-6 py-4 bg-gradient-accent hover:bg-emerald-800 text-white text-lg font-bold rounded-lg shadow-md transition-transform transform hover:scale-105">
                    ...
                    <button type="button" @click="$store.cart.addItem({
                            ...
                            quantity: qty  
                        })" class="flex-1 inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 focus:ring-4 focus:outline-none focus:ring-purple-300 text-white  text-lg font-bold rounded-lg shadow-md transition-transform transform hover:scale-105">
