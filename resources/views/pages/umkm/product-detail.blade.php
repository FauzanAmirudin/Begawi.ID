<x-umkm.layout :linkWA="$linkWA" :socials="$socials">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12"
            ...
            x-init="updateWhatsAppLink()">

            {{-- Galeri Gambar Produk --}}
            <div class="w-full">
                <img src="{{ $produk->galeri_gambar[0] }}" alt="{{ $produk->nama }}"
                    class="bg-primary-darker w-full h-auto md:h-[500px] object-cover rounded-lg shadow-lg">

                @if(count($produk->galeri_gambar) > 1)
                <div class="grid grid-cols-4 gap-4 mt-4">
                    @foreach($produk->galeri_gambar as $gambar)
                    <img src="{{ $gambar }}" alt="thumbnail"
                        class="bg-primary-darker h-24 w-full object-cover rounded-md cursor-pointer border-2 border-transparent hover:border-primary">
                    @endforeach
                </div>
                @endif
            </div>
            ...
            <div class="w-full">
                ...
                <h1 class="text-3xl md:text-4xl font-medium text-dark mb-3">
                    {{ $produk->nama }}
                </h1>

                <p class="text-3xl font-medium text-primary-dark mb-6">
                ...
                <div class="mb-6 flex items-center gap-4">
                    ...
                    <div class="flex items-center border border-gray-300 rounded-lg overflow-hidden">
                        <button type="button" @click="decrease()"
                            class="px-4 py-2 bg-gray-200 text-dark font-medium">-</button>
                ...
                <div class="flex flex-col md:flex-row gap-4 mb-8">
                    ...
                    <a href="#" x-ref="whatsappLink" target="_blank" rel="noopener noreferrer"
                        class="flex-1 inline-flex items-center justify-center px-6 py-4 bg-gradient-accent hover:bg-emerald-800 text-white text-lg font-medium rounded-lg shadow-md transition-transform transform hover:scale-105">
                    ...
                    <button type="button" @click="$store.cart.addItem({
                            ...
                            quantity: qty  
                        })" class="flex-1 inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 focus:ring-4 focus:outline-none focus:ring-purple-300 text-white  text-lg font-medium rounded-lg shadow-md transition-transform transform hover:scale-105">
                ...
                <div class="mt-8 pt-6 border-t border-gray-200">
                    <h2 class="text-xl font-medium text-dark mb-4">Deskripsi Produk</h2>
