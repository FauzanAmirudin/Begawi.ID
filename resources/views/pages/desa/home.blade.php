...
<section class="py-20 bg-white">
    <div class="max-w-[1280px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            @forelse($umkm_populer as $produk)
                ...
                <div class="p-5">
                    ...
                    <div class="flex items-center gap-1 mb-3">
                        @for($i = 1; $i <= 5; $i++)
                            ...
                            @endif
                        @endfor
                        <span class="text-sm text-slate-600 ml-1">({{ number_format($produk['rating'] ?? 0, 1) }})</span>
                    </div>
            ...
            <div class="col-span-full text-center py-12">
                ...
                <p class="text-gray-500 text-lg font-semibold mb-2">Belum ada produk UMKM populer</p>
                <p class="text-gray-400 text-sm">Produk akan muncul di sini setelah ada produk UMKM yang aktif dan memiliki rating tinggi.</p>
            </div>
            @endforelse
        </div>
    </div>
    ...
    <div class="max-w-[1280px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div class="hidden lg:block bg-white rounded-2xl shadow-lg p-8">
            <div class="grid grid-cols-7 gap-4 mb-8">
                ...
                @for($i = 1; $i <= 31; $i++)
                <div class="aspect-square border border-slate-200 rounded-lg p-2 hover:bg-slate-50 transition-colors cursor-pointer">
        ...
        <div class="lg:hidden space-y-4">
            ...
            <div class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow">
                <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1">
                        <h3 class="font-display font-semibold text-lg text-slate-800 mb-2">{{ $acara['judul'] }}</h3>
