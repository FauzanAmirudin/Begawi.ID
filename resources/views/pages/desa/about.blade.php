        ...
        <div class="grid grid-cols-12 gap-8">
            ...
            <aside class="hidden lg:block col-span-3">
                <div class="sticky-sidebar bg-white rounded-2xl shadow-md p-6">
                    ...
                    <nav class="space-y-2">
                        <a href="#identitas"
                            class="block text-slate-600 hover:text-green-700 py-2 px-3 rounded-lg hover:bg-green-50 transition-colors">
                            Identitas Desa
                        </a>
                        <a href="#visi-misi"
                            class="block text-slate-600 hover:text-green-700 py-2 px-3 rounded-lg hover:bg-green-50 transition-colors">
            ...
            <main class="col-span-12 lg:col-span-9 space-y-20">
                ...
                <section id="identitas" class="scroll-reveal">
                    <div class="bg-white rounded-2xl shadow-md p-8">
                        <h2
                            class="text-3xl font-display font-bold text-green-900 border-b-4 border-yellow-400 inline-block pb-2 mb-8">
                            Identitas Desa
                        </h2>
                        ...
                        <div class="grid grid-cols-12 gap-8 items-center">
                            ...
                            <div class="col-span-12 md:col-span-5 text-center">
                                ...
                                <h3 class="text-3xl font-display font-bold text-green-900">{{ $identitas_desa['nama'] }}
                                </h3>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div class="flex items-center gap-3 p-3 rounded-lg hover:bg-green-50 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium text-slate-700">{{ $identitas_desa['alamat'] }},
                                                {{ $identitas_desa['kecamatan'] }}, {{ $identitas_desa['kabupaten'] }},
                                                {{ $identitas_desa['provinsi'] }} {{ $identitas_desa['kode_pos'] }}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-3 p-3 rounded-lg hover:bg-green-50 transition-colors">
                                        ...
                                        <div>
                                            ...
                                            <p class="font-medium text-slate-700">{{ $identitas_desa['jumlah_penduduk'] }}
                                                (Kepadatan: {{ $identitas_desa['kepadatan'] }})</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section id="visi-misi" class="bg-green-50 py-16 px-8 rounded-3xl">
                                ...
                                <ul class="space-y-4">
                                    @foreach ($visi_misi['misi'] as $index => $misi)
                                        <li class="flex items-start gap-3 text-slate-700">
                                            <span
                                                class="flex-shrink-0 w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center text-sm font-bold">
                                                {{ $index + 1 }}
                                            </span>
                    ...
                    <div class="text-center mt-8">
                        <a href="#"
                            class="bg-yellow-400 hover:bg-yellow-500 rounded-xl px-8 py-3 text-green-900 font-semibold transition-colors inline-flex items-center gap-2">
                ...
                <section id="struktur" class="scroll-reveal">
                    <h2
                        class="text-3xl font-display font-bold text-green-900 border-b-4 border-yellow-400 inline-block pb-2 mb-12">
                        Struktur Pemerintahan
                    </h2>
                    ...
                    <div class="text-center mb-16">
                        <div class="inline-block bg-white rounded-2xl p-8 shadow-md hover:shadow-lg transition-shadow">
                            ...
                            <p class="text-green-700 font-medium">
                                {{ $struktur_pemerintahan['kepala_desa']['jabatan'] ?? 'Kepala Desa' }}</p>
                            <p class="text-sm text-slate-600 mt-1">Periode:
                                {{ $struktur_pemerintahan['kepala_desa']['periode'] ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-16">
                        ...
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-8">
                            @foreach ($struktur_pemerintahan['perangkat_desa'] as $perangkat)
                                <div
                                    class="bg-white rounded-2xl p-6 shadow-md hover:shadow-lg transition-all duration-300 text-center group">
                                    ...
                                    <h4 class="font-display font-semibold text-green-900 mb-1">
                                        {{ $perangkat['nama'] ?? 'Nama Tidak Tersedia' }}</h4>
                                    <p class="text-sm text-slate-600">
                                        {{ $perangkat['jabatan'] ?? 'Jabatan Tidak Tersedia' }}</p>
                                </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            @foreach ($struktur_pemerintahan['lembaga'] as $lembaga)
                                <div
                                    class="bg-white rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow border-l-4 border-green-600">
                                    <h4 class="font-display font-semibold text-lg text-green-900 mb-2">
                                        {{ $lembaga['nama'] ?? 'Nama Lembaga' }}</h4>
                                    <p class="text-slate-700 mb-1">Ketua: <span
                                            class="font-medium">{{ $lembaga['ketua'] ?? '-' }}</span></p>
                                    ...
                                    @foreach ($sejarah_geografi['sejarah']['tonggak_sejarah'] as $tahun => $peristiwa)
                                        <div class="timeline-item">
                                            <div class="flex items-start gap-4">
                                                <span
                                                    class="bg-green-600 text-white px-3 py-1 rounded-full text-sm font-bold min-w-fit">
                                                    {{ $tahun }}
                                                </span>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="bg-white rounded-2xl overflow-hidden shadow-md">
                                <div class="aspect-video bg-slate-200 relative overflow-hidden">
                                    <img src="{{ asset('images/' . $sejarah_geografi['foto_wilayah']) }}"
                    ...
                    <div class="bg-green-800 text-white rounded-2xl p-8 relative overflow-hidden">
                        ...
                        <div class="absolute inset-0 opacity-10">
                            <svg class="w-full h-full" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                                <pattern id="leaves" x="0" y="0" width="20" height="20"
                        ...
                        <div class="relative z-10 flex flex-col sm:flex-row justify-between items-center">
                            ...
                            <div class="flex items-center gap-6">
                                ...
                                <a href="{{ $sosial_media['instagram'] }}"
                                    ...
                                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                        <path
                                            d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.73-3.016-1.8L12.017 8.2l6.584 6.988c-.568 1.07-1.719 1.8-3.016 1.8H8.449z" />
                                    </svg>
                                </a>
