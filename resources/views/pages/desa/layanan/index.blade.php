...
<div class="sticky top-[4.5rem] z-20 bg-white border-b border-slate-200">
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        <nav class="flex space-x-8 overflow-x-auto">
            ...
            <button onclick="scrollToSection('kategori-pengaduan')" class="nav-tab whitespace-nowrap py-4 px-2 border-b-2 border-transparent text-slate-500 hover:text-slate-700 font-medium">
                Kategori Pengaduan
            </button>
        </nav>
    </div>
                ...
                <div class="bg-white rounded-2xl shadow-md p-6">
                    ...
                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center">
                            <div class="w-8 h-8 bg-teal-600 text-white rounded-full flex items-center justify-center text-sm font-medium">1</div>
                    ...
                    <form id="suratForm" onsubmit="submitSurat(event)">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" name="nama" required class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-teal-400 focus:border-transparent transition">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-2">NIK *</label>
                                <input type="text" name="nik" required class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-teal-400 focus:border-transparent transition">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-2">Nomor Telepon *</label>
                                <input type="tel" name="telepon" required class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-teal-400 focus:border-transparent transition">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-slate-700 mb-2">Email</label>
                                <input type="email" name="email" class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-teal-400 focus:border-transparent transition">
                            </div>
                        </div>
                        
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-slate-700 mb-2">Alamat Lengkap *</label>
                            <textarea name="alamat" rows="3" required class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-teal-400 focus:border-transparent transition"></textarea>
                        </div>
                        
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-slate-700 mb-2">Keperluan/Tujuan *</label>
                            <textarea name="keperluan" rows="3" required class="w-full px-4 py-3 border border-slate-300 rounded-xl focus:ring-2 focus:ring-teal-400 focus:border-transparent transition" placeholder="Jelaskan untuk keperluan apa surat ini dibutuhkan"></textarea>
                        </div>
                        ...
                        <button type="submit" class="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl">
                ...
                <div class="w-full lg:w-80">
                    <div class="bg-white rounded-2xl shadow-lg p-6">
                        <div class="flex items-center gap-3 mb-4">
                            ...
                            <div>
                                <div class="font-semibold text-slate-800">{{ $statistikPengaduan['selesai'] }} Pengaduan</div>
                        ...
                        <div class="mt-3 bg-slate-100 rounded-full h-2">
                            <div class="bg-emerald-500 h-2 rounded-full" style="width: {{ ($statistikPengaduan['selesai'] / $statistikPengaduan['total']) * 100 }}%"></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <form id="pengaduanForm" onsubmit="submitPengaduan(event)" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        placeholder="Jelaskan secara detail masalah yang ingin Anda laporkan, termasuk kronologi kejadian jika diperlukan"
                    ></textarea>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            <input type="file" id="bukti1" name="bukti[]" accept="image/*,.pdf" class="hidden">
                            <label for="bukti1" class="flex items-center gap-3 p-4 border-2 border-dashed border-slate-300 rounded-xl cursor-pointer hover:border-teal-400 hover:bg-teal-50 transition">
                        ...
                        <div>
                            <input type="file" id="bukti2" name="bukti[]" accept="image/*,.pdf" class="hidden">
                            <label for="bukti2" class="flex items-center gap-3 p-4 border-2 border-dashed border-slate-300 rounded-xl cursor-pointer hover:border-teal-400 hover:bg-teal-50 transition">
                                <svg class="w-6 h-6 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                </svg>
                                <div>
                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="text-sm text-blue-800">
                            ...
                            <div class="text-blue-700">
                                Data pribadi Anda akan dijaga kerahasiaannya dan hanya digunakan untuk keperluan penanganan pengaduan. 
                ...
                <!-- Checkbox Agreement -->
                <div class="flex items-start gap-3">
                    <input type="checkbox" id="agreement" name="agreement" required class="mt-1 w-4 h-4 text-teal-600 border-slate-300 rounded focus:ring-teal-400">
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            ...
            <div class="kategori-card bg-{{ $kategori['color'] }}-50 hover:bg-{{ $kategori['color'] }}-100 rounded-2xl p-6 text-center cursor-pointer transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg border border-{{ $kategori['color'] }}-100"
                ...
                <div class="w-16 h-16 bg-{{ $kategori['color'] }}-100 hover:bg-{{ $kategori['color'] }}-600 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-colors duration-300 group">
                    <x-desa.icon :name="$kategori['icon']" class="w-8 h-8 text-{{ $kategori['color'] }}-600 group-hover:text-white transition-colors duration-300" />
                </div>
                ...
                <div class="flex items-center justify-center gap-2">
                    <span class="bg-{{ $kategori['color'] }}-600 text-white text-xs font-medium px-3 py-1 rounded-full">
            ...
            <div class="space-y-4">
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm text-slate-600">{{ round(($statistikPengaduan['selesai'] / $statistikPengaduan['total']) * 100) }}%</span>
                    </div>
                    <div class="w-full bg-slate-200 rounded-full h-3">
                        <div class="bg-emerald-500 h-3 rounded-full transition-all duration-500" style="width: {{ ($statistikPengaduan['selesai'] / $statistikPengaduan['total']) * 100 }}%"></div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="text-sm text-slate-600">{{ round(($statistikPengaduan['proses'] / $statistikPengaduan['total']) * 100) }}%</span>
                    </div>
                    <div class="w-full bg-slate-200 rounded-full h-3">
                        <div class="bg-blue-500 h-3 rounded-full transition-all duration-500" style="width: {{ ($statistikPengaduan['proses'] / $statistikPengaduan['total']) * 100 }}%"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                    ...
                    <p class="text-slate-600 text-sm">Pengaduan akan ditanggapi maksimal 3x24 jam setelah diterima. Untuk kasus darurat, akan segera ditindaklanjuti.</p>
                </div>
                <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                    <h4 class="font-semibold text-slate-800 mb-2">Apakah identitas pelapor akan dirahasiakan?</h4>
                    <p class="text-slate-600 text-sm">Ya, identitas pelapor dapat dirahasiakan jika diminta. Namun data kontak tetap diperlukan untuk komunikasi.</p>
                </div>
                <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                    <h4 class="font-semibold text-slate-800 mb-2">Bagaimana cara melacak status pengaduan?</h4>
                    <p class="text-slate-600 text-sm">Setelah mengirim pengaduan, Anda akan mendapat kode tracking yang dapat digunakan untuk memantau progress.</p>
                </div>
                <div class="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                    <h4 class="font-semibold text-slate-800 mb-2">Apa saja yang tidak boleh dilaporkan?</h4>
                    <p class="text-slate-600 text-sm">Hindari laporan palsu, fitnah, atau hal-hal yang bersifat pribadi. Fokus pada masalah yang berkaitan dengan kepentingan umum.</p>
                </div>
            </div>
        </div>
    </div>
