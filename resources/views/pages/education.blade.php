    ...
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all hover-tilt">
                <div class="w-14 h-14 flex mb-6">
                    <img src="{{ asset('images/edu/tutorial-penggunaan.png') }}" alt="" class="w-14 h-14">
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all hover-tilt">
                <div class="w-14 h-14 flex mb-6">
                <img src="{{ asset('images/edu/artikel-inspiratif.png') }}" alt="" class="w-14 h-14">
                </div>
            ...
            <div class="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all hover-tilt">
                <div class="w-14 h-14 flex mb-6">
                    <img src="{{ asset('images/edu/tips-pemasaran-digital.png') }}" alt="" class="w-14 h-14">
                </div>
