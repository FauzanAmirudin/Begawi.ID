                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex items-start">
                                <div class="w-12 h-12 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                                    <img src="{{ asset('images/contacs/address.png') }}" alt="" class="w-12 h-12">
                                </div>
                                <div>
                            ...
                            <div class="flex items-start">
                                <div class="w-12 h-12 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                                    <img src="{{ asset('images/contacs/call.png') }}" alt="" class="w-12 h-12">
                                </div>
                                <div>
                            ...
                            <div class="flex items-start">
                                <div class="w-12 h-12 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                                    <img src="{{ asset('images/contacs/email.png') }}" alt="" class="w-12 h-12">
                                </div>
                                <div>
                            ...
                            <div class="flex items-start">
                                <div class="w-12 h-12 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                                    <img src="{{ asset('images/contacs/clock.png') }}" alt="" class="w-12 h-12">
                                </div>
                                <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <a
                    ...
                    <div class="relative z-10">
                        <div class="w-10 h-10 flex justify-center items-center mb-4 mx-auto">
                            <img src="{{ asset('images/contacs/ig.png') }}" alt="" class="w-10 h-10">
                        </div>
                ...
                <a
                    ...
                    <div class="relative z-10">
                        <div class="w-10 h-10 flex justify-center items-center mb-4 mx-auto">
                            <img src="{{ asset('images/contacs/fb.png') }}" alt="" class="w-10 h-10">
                        </div>
                ...
                <a
                    ...
                    <div class="relative z-10">
                        <div class="w-10 h-10 flex justify-center items-center mb-4 mx-auto">
                            <img src="{{ asset('images/contacs/twt.png') }}" alt="" class="w-10 h-10">
                        </div>
                ...
                <a
                    ...
                    <div class="relative z-10">
                        <div class="w-10 h-10 flex justify-center items-center mb-4 mx-auto">
                            <img src="{{ asset('images/contacs/yt.png') }}" alt="" class="w-10 h-10">
                        </div>
