...
@section('description', 'Platform pembuat website instan berbasis lokal untuk UMKM dan lembaga desa. Tanpa keahlian
    teknis, tanpa biaya besar. Mulai digitalisasi dari Begawi.id')
                    ...
                    <div class="space-y-16">
                        ...
                        <div class="flex flex-col lg:flex-row items-center">
                            <div class="lg:w-1/2 lg:pr-12 mb-8 lg:mb-0">
                                <div class="bg-white rounded-2xl p-8 shadow-xl hover-tilt">
                                    <div class="flex items-center mb-6">
                                        <div
                                            class="w-12 h-12 bg-emerald-600 rounded-xl flex items-center justify-center mr-4">
                                            <span class="text-white font-bold">1</span>
                                        </div>
                                        <h3 class="font-poppins font-bold text-2xl text-charcoal-grey">Mudah Digunakan</h3>
                                    </div>
                                    <p class="text-gray-600 leading-relaxed mb-6">
                                        Interface drag-and-drop yang intuitif. Tidak perlu coding atau keahlian teknis.
                                        Siapapun bisa membuat website profesional dalam hitungan menit.
                                    </p>
                            ...
                            <div class="lg:w-1/2 lg:pl-12">
                                <div class="relative">
                                    <img src="{{ asset('images/web-1.png') }}" alt="Easy to Use"
                                        class="w-full rounded-2xl shadow-2xl">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-tr from-emerald-600/20 to-transparent rounded-2xl">
                                    </div>
                                </div>
                            </div>
                            <!-- Timeline Dot -->
                        ...
                        <div class="flex flex-col lg:flex-row-reverse items-center">
                            <div class="lg:w-1/2 lg:pl-12 mb-8 lg:mb-0">
                                <div class="bg-white rounded-2xl p-8 shadow-xl hover-tilt">
                                    ...
                                    <p class="text-gray-600 leading-relaxed mb-6">
                                        Template dan fitur yang disesuaikan dengan kebutuhan desa dan UMKM Indonesia.
                                        Mendukung bahasa lokal dan budaya setempat.
                                    </p>
                                    <ul class="space-y-2 text-sm text-gray-500">
                                        <li class="flex items-center">
                                            <svg class="w-4 h-4 text-emerald-500 mr-2" fill="none" stroke="currentColor"
                            ...
                            <div class="lg:w-1/2 lg:pr-12">
                                <div class="relative">
                                    <img src="{{ asset('images/web-2.png') }}" alt="Local Focus"
                                        class="w-full rounded-2xl shadow-2xl">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-tr from-emerald-600/20 to-transparent rounded-2xl">
                                    </div>
                        ...
                        <div class="flex flex-col lg:flex-row items-center">
                            <div class="lg:w-1/2 lg:pr-12 mb-8 lg:mb-0">
                                <div class="bg-white rounded-2xl p-8 shadow-xl hover-tilt">
                                    <div class="flex items-center mb-6">
                                        <div
                                            class="w-12 h-12 bg-purple-600 rounded-xl flex items-center justify-center mr-4">
                                            <span class="text-white font-bold">3</span>
                                        </div>
                                        <h3 class="font-poppins font-bold text-2xl text-charcoal-grey">Gratis Selamanya</h3>
                                    </div>
                                    <p class="text-gray-600 leading-relaxed mb-6">
                                        Komitmen kami untuk mendukung digitalisasi Indonesia. Fitur dasar gratis selamanya,
                                        upgrade premium dengan harga terjangkau.
                                    </p>
                                    <ul class="space-y-2 text-sm text-gray-500">
                                        <li class="flex items-center">
                            ...
                            <div class="lg:w-1/2 lg:pl-12">
                                <div class="relative">
                                    <img src="{{ asset('images/web-3.png') }}" alt="Free Forever"
                                        class="w-full rounded-2xl shadow-2xl">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-tr from-purple-600/20 to-transparent rounded-2xl">
                                    </div>
                                </div>
                            </div>
                            <!-- Timeline Dot -->
