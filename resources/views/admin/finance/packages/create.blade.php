...
<div class="p-6">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-semibold text-gray-800">Tambah Paket Langganan</h1>
            <p class="text-sm text-gray-500 mt-1">Buat paket langganan baru</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        <form action="{{ route('admin.finance.packages.store') }}" method="POST">
            @csrf
