...
<div class="p-6 space-y-6" x-data="productForm()" x-cloak>
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <h1 class="text-3xl font-semibold text-gray-900">Edit Produk</h1>
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi produk.</p>
        </div>
    </div>

    <!-- Product Form -->
    <form action="{{ route('admin.umkm.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-2xl border border-gray-100 shadow-sm">
        @csrf
        @method('PUT')
        <div class="p-6 sm:p-10 space-y-8">
            ...
            <section class="space-y-5 pb-6 border-b border-gray-100">
                ...
                <div>
                    ...
                    <input type="text" name="title" value="{{ old('title', $product->title) }}" required class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition">
                    @error('title')
                ...
                <div>
                    ...
                    <textarea name="description" rows="4" class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition resize-none">{{ old('description', $product->description) }}</textarea>
                    @error('description')
                    <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="availability_status" required class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition">
                            <option value="ready" {{ old('availability_status', $product->availability_status) == 'ready' ? 'selected' : '' }}>Ready</option>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price" value="{{ old('price', $product->price) }}" step="0.01" min="0" required class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition">
                        </div>
                        @error('price')
                        <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-500 font-medium">Rp</span>
                            <input type="number" name="discount_price" value="{{ old('discount_price', $product->discount_price) }}" step="0.01" min="0" placeholder="Kosongkan jika tidak ada diskon" class="w-full pl-12 pr-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition">
                        </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="stock" value="{{ old('stock', $product->stock) }}" min="0" required class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition">
                        @error('stock')
                        <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <section class="space-y-5 pb-6 border-b border-gray-100">
                ...
                <div class="flex flex-wrap gap-3">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="labels[]" value="best_seller" {{ in_array('best_seller', old('labels', $product->labels ?? [])) ? 'checked' : '' }} class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
                        <span class="text-sm text-gray-700">Best Seller</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="labels[]" value="new" {{ in_array('new', old('labels', $product->labels ?? [])) ? 'checked' : '' }} class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
                        <span class="text-sm text-gray-700">Baru</span>
                    </label>
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="labels[]" value="promo" {{ in_array('promo', old('labels', $product->labels ?? [])) ? 'checked' : '' }} class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
                ...
                <div class="pt-3 border-t border-gray-100">
                    <label class="flex items-center gap-2 cursor-pointer">
                        <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $product->is_featured) ? 'checked' : '' }} class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
            ...
            <section class="space-y-5 pb-6 border-b border-gray-100">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="weight" value="{{ old('weight', $product->weight) }}" placeholder="Contoh: 500g, 1kg" class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition">
                        @error('weight')
                        <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="dimension" value="{{ old('dimension', $product->dimension) }}" placeholder="Contoh: 20x15x10 cm" class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white text-gray-900 placeholder-gray-400 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition">
                        @error('dimension')
                        <p class="text-xs text-red-500 mt-1.5">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <section class="space-y-5">
                <div>
                    ...
                    <h4 class="text-lg font-semibold text-gray-900 mt-1">Unggah Foto Produk</h4>
                ...
                <div class="image-preview-container">
                    ...
                    <div class="image-preview-item">
                        ...
                        <button type="button" onclick="this.closest('.image-preview-item').remove()" class="remove-btn">
                ...
                <div>
                    <input type="file" name="images[]" multiple accept="image/*" @change="handleImageUpload($event)" class="hidden" id="image-upload">
