...
<div class="p-6">
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-gray-600">Grafik pengunjung website UMKM (harian, mingguan, bulanan)</p>
            @if($umkmBusiness)
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-6">
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('admin.umkm.statistics.visitor-statistics', ['period' => 'daily']) }}" class="px-4 py-2 text-sm font-medium rounded-lg transition {{ request('period') === 'daily' || !request('period') ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                Harian
            </a>
            <a href="{{ route('admin.umkm.statistics.visitor-statistics', ['period' => 'weekly']) }}" class="px-4 py-2 text-sm font-medium rounded-lg transition {{ request('period') === 'weekly' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                Mingguan
            </a>
            <a href="{{ route('admin.umkm.statistics.visitor-statistics', ['period' => 'monthly']) }}" class="px-4 py-2 text-sm font-medium rounded-lg transition {{ request('period') === 'monthly' ? 'bg-purple-100 text-purple-700' : 'bg-gray-100 text-gray-700 hover:bg-gray-200' }}">
                Bulanan
            </a>
        </div>
    </div>
