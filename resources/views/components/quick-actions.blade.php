    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center mb-16">
            <h2 class="font-manrope font-extrabold text-4xl md:text-5xl text-charcoal-grey mb-4">
                Aksi Cepat untuk
                <span class="text-gradient">Memulai Digital</span>
            </h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="quick-action-card group">
                <div class="bg-gradient-to-br from-emerald-50 to-emerald-100 rounded-2xl p-8 text-center hover-tilt hover-glow transition-all duration-300 border border-emerald-200">
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Pilih template, isi konten, dan website Anda siap dalam 10 menit
                    </p>
            ...
            <div class="quick-action-card group">
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-8 text-center hover-tilt hover-glow transition-all duration-300 border border-purple-200">
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Tutorial lengkap dari dasar hingga mahir mengelola website
                    </p>
                    <button class="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-xl transition-all group-hover:shadow-lg">
                        <span class="flex items-center justify-center">
                            <span class="mr-2">📚</span>
                            Mulai Belajar
                        </span>
            ...
            <div class="quick-action-card group">
                <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8 text-center hover-tilt hover-glow transition-all duration-300 border border-orange-200">
                    ...
                    <p class="text-gray-600 mb-6 leading-relaxed">
                        Dapatkan bantuan langsung dari tim ahli kami
                    </p>
                    <button class="w-full bg-orange-600 hover:bg-orange-700 text-white font-semibold py-3 px-6 rounded-xl transition-all group-hover:shadow-lg">
                        <span class="flex items-center justify-center">
                            <span class="mr-2">💬</span>
                            Chat Sekarang
                        </span>
        ...
        <div class="mt-20">
            <div class="text-center mb-12">
                <h3 class="font-poppins font-bold text-2xl text-charcoal-grey mb-4">
