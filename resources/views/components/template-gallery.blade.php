    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center mb-16">
            ...
            <div class="flex flex-wrap justify-center gap-4 mb-12">
                ...
                <button class="category-filter px-6 py-3 bg-white border border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-primary-500 hover:text-primary-600 transition-all" data-category="desa">
                    🌾 Desa
                </button>
                <button class="category-filter px-6 py-3 bg-white border border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-primary-500 hover:text-primary-600 transition-all" data-category="umkm">
                    🛍️ UMKM
                </button>
            </div>
        </div>
                ...
                <div class="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover-tilt">
                    <div class="relative overflow-hidden">
                        ...
                        <div class="absolute top-4 left-4">
                            <span class="bg-primary-600 text-white text-xs font-bold px-3 py-1 rounded-full">🌾 DESA</span>
                        </div>
