{{--
File: resources/views/components/umkm/footer.blade.php
            ...
            <div class="flex flex-col justify-between items-center">
                ...
                <nav class="flex flex-wrap justify-center md:justify-start gap-4 md:gap-6">
                    <a href="{{ route('umkm.home') }}"
                        class="text-sm font-medium text-light hover:text-accent dark:hover:text-primary-light transition-colors">
                        Home
                    </a>
                ...
                <div class="flex space-x-4 mb-6">
                    <a href="#"
                        class="w-10 h-10 bg-white/10 hover:bg-primary-600 rounded-lg flex items-center justify-center transition-all hover-glow">
                    ...
                    <a href="#"
                        class="w-10 h-10 bg-white/10 hover:bg-pink-600 rounded-lg flex items-center justify-center transition-all hover-glow">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="#"
                        class="w-10 h-10 bg-white/10 hover:bg-red-600 rounded-lg flex items-center justify-center transition-all hover-glow">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            <path
